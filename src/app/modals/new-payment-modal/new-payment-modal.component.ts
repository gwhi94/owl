...
export class NewPaymentModalComponent implements OnInit {
  ...
  constructor(private auth:AuthService, private errorService:ErrorService, private fb:FormBuilder,public dialogRef: MatDialogRef<NewPaymentModalComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {this.rForm = fb.group({
